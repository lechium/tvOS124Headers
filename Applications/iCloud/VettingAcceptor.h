...
- (void).cxx_destruct;	// IMP=0x0000000100019d08
- (void)dealloc;	// IMP=0x0000000100019c40
- (void)completeVettingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000194c8
- (void)retrievingDialogCancelled;	// IMP=0x000000010001946c
- (_Bool)retrievingDialogShouldDisplay;	// IMP=0x0000000100019464
- (id)initWithCloudKitURL:(id)arg1;	// IMP=0x000000010001934c
