...
@interface TVWiFiCertificateSummaryCell : TSKBaseTableViewCell
{
...
+ (id)dateFormatter;	// IMP=0x0000000100088c0c
...
- (void).cxx_destruct;	// IMP=0x000000010008a850
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010008a6cc
- (void)_updateCellBackground;	// IMP=0x000000010008a604
- (id)_newTitleLabel;	// IMP=0x000000010008a558
- (id)_newSubtitleLabel;	// IMP=0x000000010008a4f0
- (id)_subtitleFont;	// IMP=0x000000010008a468
- (id)_titleFont;	// IMP=0x000000010008a3e0
- (void)updateConstraints;	// IMP=0x00000001000895ec
- (_Bool)canBecomeFocused;	// IMP=0x00000001000895e4
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000100088c8c
