...
- (void).cxx_destruct;	// IMP=0x00000001000535b8
- (void)setTintColor:(id)arg1;	// IMP=0x00000001000534f8
- (void)layoutSubviews;	// IMP=0x0000000100053144
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100053078
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100052db8
