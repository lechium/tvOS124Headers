...
- (void)_stopAnimations;	// IMP=0x0000000100032e40
- (void)_startAnimations;	// IMP=0x00000001000324ec
- (void)_addImageToAnimationContainer:(id)arg1;	// IMP=0x000000010003221c
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010003220c
- (void)layoutSubviews;	// IMP=0x0000000100031a80
- (void)didMoveToWindow;	// IMP=0x00000001000319c4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000318e8
