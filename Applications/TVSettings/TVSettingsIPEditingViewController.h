...
- (void)_menuPressed;	// IMP=0x000000010002e0c8
- (id)_promptText;	// IMP=0x000000010002e058
- (void)ipEntryViewControllerDidFinish:(id)arg1;	// IMP=0x000000010002dfd0
- (void)viewDidLoad;	// IMP=0x000000010002ddec
- (id)title;	// IMP=0x000000010002dde4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010002dd24
