...
- (void).cxx_destruct;	// IMP=0x0000000100013124
- (id)preferredFocusEnvironments;	// IMP=0x000000010001303c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100012f4c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100012cb8
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000100012c30
