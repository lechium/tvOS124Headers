...
- (void).cxx_destruct;	// IMP=0x000000010001b3d8
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x000000010001b274
- (void)_setImage:(id)arg1;	// IMP=0x000000010001b100
- (id)_imageView;	// IMP=0x000000010001af68
- (void)_loadImage;	// IMP=0x000000010001a858
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010001a6e4
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010001a2f4
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010001a1e8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010001a140
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000010001a0cc
- (void)setContentMode:(long long)arg1;	// IMP=0x000000010001a0a8
- (void)layoutSubviews;	// IMP=0x000000010001a03c
- (long long)contentMode;	// IMP=0x000000010001a024
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010001a00c
- (void)dealloc;	// IMP=0x0000000100019fa0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100019eb4
