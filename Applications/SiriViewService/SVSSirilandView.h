...
+ (id)sirilandView;	// IMP=0x0000000100041f64
...
- (void).cxx_destruct;	// IMP=0x00000001000426b8
- (void)statusBarFrameDidChange;	// IMP=0x0000000100042548
- (_Bool)_keylineIsVisible;	// IMP=0x0000000100042510
- (void)layoutSubviews;	// IMP=0x00000001000421f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100041f8c
