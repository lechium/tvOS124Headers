...
- (void).cxx_destruct;	// IMP=0x0000000100023c10
- (_Bool)isActive;	// IMP=0x0000000100023b38
- (void)viewDidLoad;	// IMP=0x0000000100023868
- (void)loadView;	// IMP=0x00000001000237b4
- (id)init;	// IMP=0x0000000100023644
