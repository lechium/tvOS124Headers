...
- (void).cxx_destruct;	// IMP=0x00000001000442a0
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00000001000441a4
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0000000100044108
- (void)incrementNumberOfStartedActions;	// IMP=0x00000001000440d0
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100043d98
