...
+ (id)activationEngineWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x00000001000990fc
...
- (void).cxx_destruct;	// IMP=0x000000010009b0fc
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000010009ada0
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010009aac0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010009aa08
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010009a928
- (void)makeRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010009a7e0
- (void)tryActivateWithOptions:(id)arg1 requestMutator:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010009a3f4
- (void)_sendSessionRequest:(id)arg1 withOptions:(id)arg2;	// IMP=0x0000000100099a8c
- (id)_newActivationRequestWithOptions:(id)arg1 sessionData:(id)arg2 error:(id *)arg3;	// IMP=0x000000010009948c
@property(readonly, nonatomic) NSURLSession *session;
- (void)_cleanup;	// IMP=0x0000000100099308
- (void)cancel;	// IMP=0x0000000100099230
- (id)initWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x000000010009917c
