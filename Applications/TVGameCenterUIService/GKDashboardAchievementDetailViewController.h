...
- (void)share:(id)arg1;	// IMP=0x00000001000079c8
- (void)challenge:(id)arg1;	// IMP=0x00000001000078c4
- (void)configureForAchievements;	// IMP=0x0000000100007080
- (id)preferredFocusEnvironments;	// IMP=0x0000000100006ffc
- (void)viewDidLoad;	// IMP=0x0000000100006f64
- (void)dealloc;	// IMP=0x0000000100006ef4
- (id)initWithAchievement:(id)arg1 localAchievement:(id)arg2;	// IMP=0x0000000100006e18
