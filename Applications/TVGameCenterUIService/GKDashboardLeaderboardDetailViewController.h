...
- (void)report:(id)arg1;	// IMP=0x0000000100015490
- (void)share:(id)arg1;	// IMP=0x00000001000152f0
- (void)challenge:(id)arg1;	// IMP=0x000000010001510c
- (void)configureForScore;	// IMP=0x0000000100014bbc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100014b38
- (void)viewDidLoad;	// IMP=0x0000000100014904
- (void)dealloc;	// IMP=0x0000000100014894
- (id)initWithScore:(id)arg1 leaderboard:(id)arg2;	// IMP=0x00000001000147b8
