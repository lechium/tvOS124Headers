...
- (void).cxx_destruct;	// IMP=0x0000000100148d88
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100148be4
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100148a28
- (_Bool)_hasResults;	// IMP=0x00000001001489a0
- (id)_extraObjects;	// IMP=0x00000001001488d8
- (id)allObjects;	// IMP=0x0000000100148808
- (void)_initializeFrc;	// IMP=0x000000010014875c
