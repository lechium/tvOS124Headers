...
@class MTEpisode, MTPlayerItem, NSArray, NSString;
...
- (NSArray *)universalPlaybackQueueIdentifiersForPodcastUuid:(NSString *)arg1 playbackOrder:(long long)arg2 limit:(long long)arg3 queueStatus:(out unsigned long long *)arg4;
- (NSArray *)universalPlaybackQueueIdentifiersForPodcastUuid:(NSString *)arg1 sampPlaybackOrder:(NSString *)arg2 limit:(long long)arg3 queueStatus:(out unsigned long long *)arg4;
