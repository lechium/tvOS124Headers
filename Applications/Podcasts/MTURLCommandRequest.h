...
@interface MTURLCommandRequest : NSObject <NSCopying>
{
    ...
    NSString *_episodeUuid;	// 72 = 0x48
    NSString *_podcastAdamId;	// 80 = 0x50
    NSString *_episodeAdamId;	// 88 = 0x58
    NSString *_stationUuid;	// 96 = 0x60
}
...
- (void).cxx_destruct;	// IMP=0x00000001000becb0
- (void)_lookupEpisodeUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000be988
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000be720
- (void)_loadQueryParameterValuesFromString:(id)arg1;	// IMP=0x00000001000be248
- (id)copyWithPlayReason:(unsigned long long)arg1;	// IMP=0x00000001000be214
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000be090
- (id)initWithURLString:(id)arg1;	// IMP=0x00000001000bdffc
