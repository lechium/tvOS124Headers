...
- (void).cxx_destruct;	// IMP=0x0000000100010858
- (void)configureUIControls;	// IMP=0x0000000100010284
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100010068
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x0000000100010008
- (void)layoutSubviews;	// IMP=0x000000010000fc04
- (id)preferredFocusEnvironments;	// IMP=0x000000010000fa34
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000f7cc
