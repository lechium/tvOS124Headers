...
- (void).cxx_destruct;	// IMP=0x0000000100079930
- (void)highlightedAlbumChanged;	// IMP=0x00000001000794dc
- (void)viewDidLoad;	// IMP=0x0000000100079180
- (id)preferredFocusEnvironments;	// IMP=0x00000001000790f0
