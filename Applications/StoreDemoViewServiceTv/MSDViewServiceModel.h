...
+ (id)sharedInstance;	// IMP=0x0000000100004aa4
...
- (void).cxx_destruct;	// IMP=0x00000001000052d8
- (void)operationFailed:(id)arg1;	// IMP=0x00000001000051c8
- (void)didReceiveProgress:(long long)arg1;	// IMP=0x00000001000050c8
- (void)didReceiveError:(id)arg1;	// IMP=0x0000000100005020
- (void)blockingStateChanged:(_Bool)arg1;	// IMP=0x0000000100004f84
- (id)errorMessageFromErrors;	// IMP=0x0000000100004c3c
- (id)init;	// IMP=0x0000000100004b24
