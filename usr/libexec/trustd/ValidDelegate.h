...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001e990
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010001e754
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010001e1b8
- (long long)versionFromTask:(id)arg1;	// IMP=0x000000010001e160
- (void)updateDb:(unsigned long long)arg1;	// IMP=0x000000010001df58
- (void)reschedule;	// IMP=0x000000010001dd5c
