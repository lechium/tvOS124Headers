...
- (void)clearCacheServerUrl;	// IMP=0x0000000100012944
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x0000000100012924
- (double)currentEstimate;	// IMP=0x0000000100012798
- (void)updateDownloadData:(long long)arg1;	// IMP=0x0000000100012750
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0000000100012580
- (void)dealloc;	// IMP=0x000000010001245c
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x00000001000122e4
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x0000000100012180
