...
- (_Bool)verifyResponse:(id)arg1 signature:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100008480
- (_Bool)verifyCerts:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000814c
- (_Bool)determineAlg:(id)arg1;	// IMP=0x00000001000080c4
- (id)init;	// IMP=0x0000000100008074
