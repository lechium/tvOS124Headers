...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001d200
- (void)dealloc;	// IMP=0x000000010001d1cc
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x000000010001d17c
