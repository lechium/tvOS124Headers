...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000010005be88
- (id)description;	// IMP=0x000000010005bc54
- (void)invalidate;	// IMP=0x000000010005bbc8
- (void)dealloc;	// IMP=0x000000010005baec
- (id)init;	// IMP=0x000000010005ba8c
