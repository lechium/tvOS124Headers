...
+ (id)accessibilityHIDServices;	// IMP=0x000000010005f30c
...
- (void).cxx_destruct;	// IMP=0x000000010005f5e4
- (id)initWithSenderID:(unsigned long long)arg1;	// IMP=0x000000010005f4b8
