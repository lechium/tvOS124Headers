...
- (void).cxx_destruct;	// IMP=0x000000010005fa24
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010005f84c
- (id)initWithPolicyPersistence:(id)arg1;	// IMP=0x000000010005f7cc
