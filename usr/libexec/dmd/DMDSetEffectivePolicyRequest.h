...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100066b48
...
- (void).cxx_destruct;	// IMP=0x0000000100067138
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100066e74
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100066b50
