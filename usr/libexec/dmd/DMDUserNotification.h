...
- (void).cxx_destruct;	// IMP=0x000000010006f5d0
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x000000010006f498
- (struct __CFUserNotification *)notificationRef;	// IMP=0x000000010006f488
- (void)dealloc;	// IMP=0x000000010006f434
- (id)init;	// IMP=0x000000010006f3a4
