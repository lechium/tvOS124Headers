...
- (void).cxx_destruct;	// IMP=0x0000000100033a54
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x0000000100033868
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010003369c
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000334d0
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x000000010003343c
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x000000010003324c
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x000000010003316c
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x00000001000328a0
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x000000010003276c
