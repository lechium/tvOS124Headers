...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x000000010004962c
- (id)description;	// IMP=0x00000001000495a0
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x00000001000494a4
