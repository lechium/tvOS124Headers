...
- (void)networkDidChange;	// IMP=0x000000010003c1c4
- (void)keybagLockStateDidChange;	// IMP=0x000000010003c154
- (void)stopObservingChanges;	// IMP=0x000000010003c0f8
- (void)startObservingChanges;	// IMP=0x000000010003bcf4
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x000000010003bbe8
