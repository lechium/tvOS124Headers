...
- (void).cxx_destruct;	// IMP=0x0000000100002a54
- (id)_purgeTasksForUrgency:(long long)arg1;	// IMP=0x00000001000028c4
- (void)cancelPurge;	// IMP=0x0000000100002828
- (long long)purgeAmount:(long long)arg1 withUrgency:(long long)arg2 isPeriodic:(_Bool)arg3;	// IMP=0x0000000100002374
- (long long)purgeAmount:(long long)arg1 withUrgency:(long long)arg2;	// IMP=0x0000000100002364
- (long long)purgeableAmountWithUrgency:(long long)arg1;	// IMP=0x0000000100001f68
- (void)registerForCallbacks;	// IMP=0x0000000100001c44
- (id)initWithCacheDeleteID:(id)arg1;	// IMP=0x0000000100001b80
