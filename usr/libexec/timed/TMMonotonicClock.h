...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x000000010001398c
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100013090
- (void)dealloc;	// IMP=0x0000000100013038
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x0000000100012f64
- (id)init;	// IMP=0x0000000100012ed4
