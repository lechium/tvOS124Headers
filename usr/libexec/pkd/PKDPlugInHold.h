...
- (unsigned long long)hash;	// IMP=0x00000001000153e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100015310
- (void)dealloc;	// IMP=0x00000001000152cc
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x000000010001517c
