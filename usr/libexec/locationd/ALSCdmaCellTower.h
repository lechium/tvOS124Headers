...
- (unsigned long long)hash;	// IMP=0x00000001005e5960
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005e5774
- (void)copyTo:(id)arg1;	// IMP=0x00000001005e5558
- (void)writeTo:(id)arg1;	// IMP=0x00000001005e5334
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005e532c
- (id)dictionaryRepresentation;	// IMP=0x00000001005e4868
- (id)description;	// IMP=0x00000001005e47e8
...
- (void)dealloc;	// IMP=0x00000001005e44dc
