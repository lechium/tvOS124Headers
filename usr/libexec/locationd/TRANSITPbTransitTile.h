...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010018a6e0
- (unsigned long long)hash;	// IMP=0x000000010018a51c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018a32c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018a148
- (void)copyTo:(id)arg1;	// IMP=0x0000000100189fb8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100189e4c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100189e44
- (id)dictionaryRepresentation;	// IMP=0x0000000100189400
- (id)description;	// IMP=0x0000000100189380
...
- (void)dealloc;	// IMP=0x0000000100189050
