...
- (unsigned long long)hash;	// IMP=0x0000000100612d70
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100612c88
- (void)copyTo:(id)arg1;	// IMP=0x0000000100612bd0
- (void)writeTo:(id)arg1;	// IMP=0x0000000100612aa8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100612aa0
- (id)dictionaryRepresentation;	// IMP=0x0000000100612694
- (id)description;	// IMP=0x0000000100612614
@property(nonatomic) _Bool hasChannel;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0000000100612544
