...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001002de7e4
- (unsigned long long)hash;	// IMP=0x00000001002de1e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001002dddf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002dda28
- (void)copyTo:(id)arg1;	// IMP=0x00000001002dd69c
- (void)writeTo:(id)arg1;	// IMP=0x00000001002dd330
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001002dd328
- (id)dictionaryRepresentation;	// IMP=0x00000001002dbb48
- (id)description;	// IMP=0x00000001002dbac8
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00000001002db908
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00000001002db864
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00000001002dae10
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00000001002dab0c
