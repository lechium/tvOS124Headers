...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100455c48
- (unsigned long long)hash;	// IMP=0x00000001004558f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010045573c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001004555ec
- (void)copyTo:(id)arg1;	// IMP=0x00000001004554d8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100455374
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010045536c
- (id)dictionaryRepresentation;	// IMP=0x00000001004545f8
- (id)description;	// IMP=0x0000000100454578
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x00000001004543d8
- (id)metSourceAsString:(int)arg1;	// IMP=0x0000000100454344
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0000000100453f3c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0000000100453c38
