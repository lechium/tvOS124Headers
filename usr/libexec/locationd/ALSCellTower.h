...
- (unsigned long long)hash;	// IMP=0x00000001005f9b28
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005f99e8
- (void)copyTo:(id)arg1;	// IMP=0x00000001005f988c
- (void)writeTo:(id)arg1;	// IMP=0x00000001005f9704
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005f96fc
- (id)dictionaryRepresentation;	// IMP=0x00000001005f8ef8
- (id)description;	// IMP=0x00000001005f8e78
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x00000001005f8d68
