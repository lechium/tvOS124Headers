...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x0000000100684ff8
- (void)invalidate;	// IMP=0x0000000100684f88
- (void)dealloc;	// IMP=0x0000000100684f24
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100684e00
- (id)init;	// IMP=0x0000000100684dc4
