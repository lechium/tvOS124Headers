...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001f9b34
- (unsigned long long)hash;	// IMP=0x00000001001f996c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001f982c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001f9730
- (void)copyTo:(id)arg1;	// IMP=0x00000001001f9670
- (void)writeTo:(id)arg1;	// IMP=0x00000001001f9574
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001f956c
- (id)dictionaryRepresentation;	// IMP=0x00000001001f8e74
- (id)description;	// IMP=0x00000001001f8df4
