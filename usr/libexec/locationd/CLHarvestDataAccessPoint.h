...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010022fc8c
...
- (id)description;	// IMP=0x0000000100230314
- (id)jsonObject;	// IMP=0x0000000100230100
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010022ffc0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010022fe4c
- (void)dealloc;	// IMP=0x000000010022fdf4
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x000000010022fc94
