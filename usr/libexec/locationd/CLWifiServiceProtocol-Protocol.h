...
- (void)startScanWithType:(BOOL)arg1 lowPriority:(_Bool)arg2 passive:(_Bool)arg3;
...
- (_Bool)syncgetStartScanWithType:(BOOL)arg1 lowPriority:(_Bool)arg2 passive:(_Bool)arg3;
