...
- (void)dealloc;	// IMP=0x00000001001a2320
- (id)initWithHomeUUID:(id)arg1 actionSetUUID:(id)arg2 actionSetName:(id)arg3 actionSetType:(id)arg4 clientName:(id)arg5 sceneName:(id)arg6;	// IMP=0x00000001001a2230
