...
- (unsigned long long)hash;	// IMP=0x00000001005e75f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005e74b4
- (void)copyTo:(id)arg1;	// IMP=0x00000001005e7378
- (void)writeTo:(id)arg1;	// IMP=0x00000001005e7214
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005e720c
- (id)dictionaryRepresentation;	// IMP=0x00000001005e6bdc
- (id)description;	// IMP=0x00000001005e6b5c
...
- (void)dealloc;	// IMP=0x00000001005e69cc
