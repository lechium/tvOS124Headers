...
- (void).cxx_destruct;	// IMP=0x000000010003d72c
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010003d5f4
- (unsigned long long)hash;	// IMP=0x000000010003d534
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003d400
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003d2fc
- (void)copyTo:(id)arg1;	// IMP=0x000000010003d230
- (void)writeTo:(id)arg1;	// IMP=0x000000010003d16c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010003d164
- (id)dictionaryRepresentation;	// IMP=0x000000010003cb68
- (id)description;	// IMP=0x000000010003cab4
