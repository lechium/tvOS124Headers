...
- (void).cxx_destruct;	// IMP=0x000000010000b9c0
- (void)recordBytes:(unsigned long long)arg1 bundleID:(id)arg2;	// IMP=0x000000010000b1c4
- (void)deleteMetrics;	// IMP=0x000000010000b0e8
- (void)saveMetrics;	// IMP=0x000000010000ae9c
- (void)readMetrics;	// IMP=0x000000010000ab88
- (id)initWithStageURL:(id)arg1 reportHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000a8ec
