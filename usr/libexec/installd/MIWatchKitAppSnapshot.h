...
- (void).cxx_destruct;	// IMP=0x000000010002247c
- (_Bool)createSnapshotWithError:(id *)arg1;	// IMP=0x00000001000221b0
- (void)dealloc;	// IMP=0x0000000100022138
- (id)initWithBundleID:(id)arg1 snapshotTo:(id)arg2 onlyV1AppIfPresent:(_Bool)arg3 placeholderOnly:(_Bool)arg4;	// IMP=0x0000000100022050
