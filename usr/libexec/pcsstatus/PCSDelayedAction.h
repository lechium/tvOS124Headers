...
@interface PCSDelayedAction : NSObject
{
    ...
    long long _pendingTransaction;	// 56 = 0x38
...
@property long long pendingTransaction; // @synthesize pendingTransaction=_pendingTransaction;
...
- (void)trigger;	// IMP=0x0000000100005b40
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0000000100005aa0
- (void)run;	// IMP=0x0000000100005a80
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x0000000100005a34
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x0000000100005668
