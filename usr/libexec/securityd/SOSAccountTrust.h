...
+ (id)trust;	// IMP=0x00000001000b330c
...
- (void).cxx_destruct;	// IMP=0x00000001000b3228
@property(readonly, nonatomic) NSString *peerID;
@property(readonly, nonatomic) struct __OpaqueSOSPeerInfo *peerInfo;
- (void)dealloc;	// IMP=0x00000001000b2fc4
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001000b2ecc
- (id)init;	// IMP=0x00000001000b2dd8
