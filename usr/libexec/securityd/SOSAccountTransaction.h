...
- (void).cxx_destruct;	// IMP=0x0000000100079310
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x0000000100079254
- (void)requestSyncWith:(id)arg1;	// IMP=0x0000000100079198
- (void)finish;	// IMP=0x000000010007629c
- (void)restart;	// IMP=0x0000000100076268
- (void)start;	// IMP=0x0000000100075ec8
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x0000000100075e2c
