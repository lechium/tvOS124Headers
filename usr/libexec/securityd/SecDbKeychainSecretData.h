...
- (void).cxx_destruct;	// IMP=0x0000000100035fd8
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000100035cc4
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x0000000100035ad4
