...
- (void).cxx_destruct;	// IMP=0x00000001000354cc
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000100035348
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x0000000100035254
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x000000010003518c
