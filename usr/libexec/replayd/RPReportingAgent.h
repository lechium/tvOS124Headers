...
+ (void)reportSessionEnded:(unsigned short)arg1 endReason:(long long)arg2 withServiceName:(id)arg3;	// IMP=0x0000000100013a88
...
- (void).cxx_destruct;	// IMP=0x0000000100014024
- (void)reportEventWithType:(unsigned short)arg1 dictionary:(id)arg2;	// IMP=0x0000000100013678
- (id)collectSummaryEventMetrics;	// IMP=0x00000001000131ec
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100013178
