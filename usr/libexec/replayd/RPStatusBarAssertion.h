...
- (void).cxx_destruct;	// IMP=0x0000000100010f34
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x0000000100010cd0
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100010ccc
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100010cc8
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100010bac
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x0000000100010aa4
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100010aa0
- (void)startRepeatingTimer;	// IMP=0x0000000100010994
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x0000000100010990
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x000000010001092c
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x0000000100010928
