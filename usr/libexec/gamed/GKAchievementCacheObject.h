...
+ (id)entityName;	// IMP=0x00000001000340b8
- (id)internalRepresentation;	// IMP=0x00000001000340b0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100033ea4
