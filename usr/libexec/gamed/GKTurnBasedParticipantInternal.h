...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100112d8c
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010011326c
- (id)serverRepresentation;	// IMP=0x0000000100113064
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100112f84
- (unsigned long long)hash;	// IMP=0x0000000100112f68
- (void)dealloc;	// IMP=0x0000000100112cb8
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010011a324
