...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011355c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100113884
- (unsigned long long)hash;	// IMP=0x000000010011386c
- (void)dealloc;	// IMP=0x0000000100113460
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010011a524
