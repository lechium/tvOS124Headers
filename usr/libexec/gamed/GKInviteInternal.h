...
@interface GKInviteInternal : GKInternalRepresentation
{
    ...
    int _playerGroup;	// 104 = 0x68
    unsigned int _playerAttributes;	// 108 = 0x6c
    int _peerNATType;	// 112 = 0x70
    unsigned long long _matchType;	// 120 = 0x78
    unsigned char _version;	// 128 = 0x80
    NSString *_participantID;	// 136 = 0x88
}

+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100115148
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0000000100114f5c
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x0000000100114e08
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x0000000100114824
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100115544
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011549c
- (unsigned long long)hash;	// IMP=0x0000000100115478
- (void)dealloc;	// IMP=0x0000000100114ffc
- (id)init;	// IMP=0x0000000100114f98
