...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010007cad0
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010007d434
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007cb98
- (id)initWithChallenge:(id)arg1;	// IMP=0x000000010007cb30
- (id)challengeInternalObject;	// IMP=0x000000010007cb28
- (id)description;	// IMP=0x000000010007cad8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010007c9a4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010007c760
- (void)dealloc;	// IMP=0x000000010007c664
