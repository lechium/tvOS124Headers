...
@interface GKGameInternal : GKGameDescriptor
{
    ...
    NSDictionary *_icons;	// 56 = 0x38
    NSString *_defaultLeaderboardIdentifier;	// 64 = 0x40
    GKStoreItemInternal *_storeItem;	// 72 = 0x48
    union {
        struct {
    ...
    unsigned short _numberOfLeaderboards;	// 84 = 0x54
    unsigned short _numberOfLeaderboardSets;	// 86 = 0x56
    unsigned short _numberOfAchievements;	// 88 = 0x58
    unsigned short _maxAchievementPoints;	// 90 = 0x5a
}

+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fdf18
+ (id)propertiesToFetch;	// IMP=0x00000001001166e8
...
- (id)description;	// IMP=0x00000001000fe2bc
- (id)serverRepresentation;	// IMP=0x00000001000fe1d4
- (void)dealloc;	// IMP=0x00000001000fde80
- (unsigned long long)hash;	// IMP=0x00000001000fde5c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000fddcc
- (id)defaultCategory;	// IMP=0x00000001000fe614
- (unsigned short)numberOfCategories;	// IMP=0x00000001000fe608
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100116944
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100116214
