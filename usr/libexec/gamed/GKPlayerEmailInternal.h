...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001067ec
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100106760
...
- (unsigned long long)hash;	// IMP=0x00000001001069a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001068f0
- (void)dealloc;	// IMP=0x0000000100106768
