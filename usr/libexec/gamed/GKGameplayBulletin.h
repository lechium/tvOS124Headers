...
- (void)loadOriginatorPlayerWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000da0c0
- (void)loadStoreItemWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d9270
- (void)gamePlatformWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d8d88
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d8074
- (void)determineGameLocationOnDeviceViaCompatibilityMatrixWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d72fc
- (void)determineGameLocationOnDeviceOnly;	// IMP=0x00000001000d6e58
- (_Bool)isCompatibleWithGameDescriptor:(id)arg1;	// IMP=0x00000001000d6b60
- (_Bool)isPushFromLocalPlayers;	// IMP=0x00000001000d6960
- (_Bool)isPushForLocalPlayers;	// IMP=0x00000001000d6760
- (_Bool)playerIsLocal:(id)arg1;	// IMP=0x00000001000d643c
@property(readonly, retain) NSString *URLContext;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000d604c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000d5b44
- (void)dealloc;	// IMP=0x00000001000d5a34
