...
+ (id)entityName;	// IMP=0x0000000100041f50
- (id)internalRepresentation;	// IMP=0x00000001000425f8
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x0000000100041f5c
