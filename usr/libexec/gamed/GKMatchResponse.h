...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000755c0
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00000001000757c0
- (_Bool)isCancelled;	// IMP=0x0000000100075780
- (_Bool)isFinished;	// IMP=0x0000000100075740
- (int)_incrementSequence;	// IMP=0x0000000100075720
- (void)dealloc;	// IMP=0x00000001000754ec
