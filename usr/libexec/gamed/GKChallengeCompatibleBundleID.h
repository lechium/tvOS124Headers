...
+ (id)entityName;	// IMP=0x0000000100045080
- (id)internalRepresentation;	// IMP=0x000000010004508c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004507c
