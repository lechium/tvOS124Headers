...
+ (id)entityName;	// IMP=0x000000010003d6c4
- (id)internalRepresentation;	// IMP=0x000000010003d44c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010003d118
