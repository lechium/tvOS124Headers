...
+ (id)entityName;	// IMP=0x0000000100037234
- (id)internalRepresentation;	// IMP=0x0000000100037028
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100036bc4
