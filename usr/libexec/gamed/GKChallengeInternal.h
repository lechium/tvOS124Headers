...
+ (id)internalRepresentation;	// IMP=0x000000010010c64c
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010010c178
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010010cbcc
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x000000010010c77c
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x000000010010c660
- (id)serverRepresentation;	// IMP=0x000000010010c654
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010c5bc
- (unsigned long long)hash;	// IMP=0x000000010010c598
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010010c4c4
- (void)dealloc;	// IMP=0x000000010010c3c8
