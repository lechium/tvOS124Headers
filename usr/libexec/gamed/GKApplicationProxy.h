...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x000000010007642c
...
- (id)bundleURL;	// IMP=0x0000000100076670
...
- (void)dealloc;	// IMP=0x0000000100076524
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000001000763ec
- (id)initWithProxy:(id)arg1;	// IMP=0x000000010007638c
