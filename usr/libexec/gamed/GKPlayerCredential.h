...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000ffe14
...
- (id)description;	// IMP=0x00000001000ffd20
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x00000001000ffb78
- (unsigned long long)hash;	// IMP=0x00000001000ffb54
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000ffaa0
