...
- (void).cxx_destruct;	// IMP=0x0000000100069b44
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100069760
- (void)stop;	// IMP=0x00000001000696d0
- (_Bool)start;	// IMP=0x0000000100069460
- (void)setReadyToSleep;	// IMP=0x000000010006925c
- (_Bool)sleepPending;	// IMP=0x0000000100069220
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100069158
