...
#import <TVMLKit/_TVBrowserProviding.h>
#import <UIKit/UICollectionViewDelegateFlowLayout.h>

@protocol __TVShelfViewControllerDelegate;
@class NSIndexPath, _TVMLBrowserViewController, NSString;

@interface _TVShelfViewController : _TVMLCollectionViewController <TVShelfViewLayoutDelegate, _TVBrowserProviding, UICollectionViewDelegateFlowLayout> {
