...
-(void)playerViewController:(id)arg1 willResumePlaybackAfterUserNavigatedFromTime:(SCD_Struct_TV16)arg2 toTime:(SCD_Struct_TV16)arg3;
-(SCD_Struct_TV16*)playerViewController:(id)arg1 timeToSeekAfterUserNavigatedFromTime:(SCD_Struct_TV16)arg2 toTime:(SCD_Struct_TV16)arg3;
