...
@interface _TVAppDocumentController : UIViewController <UIGestureRecognizerDelegate, _TVModalPresenterFocusing, _TVPagePerformanceDelegate, _TVIKAppDocumentDelegate, IKAppDocumentDelegate> {
